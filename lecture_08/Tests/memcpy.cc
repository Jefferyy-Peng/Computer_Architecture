...
)
{
	...
	printf("n = %6d : instructions = %6lu, cycles = %6lu, L1D accesses= %6lu, L1D hits = %6lu, predict wrong rate = %.6f",
		n, pipelined::counters::operations, pipelined::counters::cycles, pipelined::caches::L1D.accesses, pipelined::caches::L1D.hits, (float)(pipelined::counters::wrong_pred)/(float)(pipelined::counters::operations));
