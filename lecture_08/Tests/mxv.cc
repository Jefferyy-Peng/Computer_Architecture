...
void test_mxv(u32 m, u32 n)
{
    ...
    printf("M = %4d, N = %4d : instr = %6lu, cyc = %8lu, L1D(access= %6lu, hit = %6lu, miss = %6lu), L2(miss = %6lu), L3(miss = %6lu), predict wrong rate = %.6f | ",
	    ...
	    pipelined::caches::L2.misses, pipelined::caches::L3.misses, (float)(pipelined::counters::wrong_pred)/(float)(pipelined::counters::operations));
    bool pass = true;
